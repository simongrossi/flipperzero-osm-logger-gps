...
static const Preset DEFAULT_PRESETS[] = {
    {"Banc", "amenity", {"bench"}, 1},
    {"Poubelle", "amenity", {"waste_basket"}, 1},
    {"Fontaine", "amenity", {"drinking_water", "fountain"}, 2},
    {"Toilettes", "amenity", {"toilets"}, 1},
    {"Lampadaire", "highway", {"street_lamp"}, 1},
    {"Boite aux lettres", "amenity", {"post_box"}, 1},
    {"Panneau info", "tourism", {"information"}, 1},
    {"Table picnic", "leisure", {"picnic_table"}, 1},
    {"Arbre", "natural", {"tree"}, 1},
    {"Passage pieton", "highway", {"crossing"}, 1},
    {"Arret de bus", "highway", {"bus_stop"}, 1},
    {"Parking velo", "amenity", {"bicycle_parking"}, 1},
    {"Parking auto", "amenity", {"parking", "motorcycle_parking"}, 2},
    {"Borne de charge", "amenity", {"charging_station"}, 1},
    {"Aire de jeux", "leisure", {"playground"}, 1},
    {"Panier de basket", "amenity", {"basketball_hoop"}, 1},
    {"Recyclage", "amenity", {"recycling"}, 1},
    {"Pharmacie", "amenity", {"pharmacy"}, 1},
    {"Cafe", "amenity", {"cafe", "pub", "bar", "fast_food"}, 4},
    {"Restaurant", "amenity", {"restaurant"}, 1},
    {"Boulangerie", "shop", {"bakery"}, 1},
    {"Defibrillateur", "emergency", {"defibrillator"}, 1},
    {"Bouche incendie", "emergency", {"fire_hydrant"}, 1},
};
